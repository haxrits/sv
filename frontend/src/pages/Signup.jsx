...
import { Person, Mail, Lock, Visibility, VisibilityOff, Favorite, Comment, AutoAwesome } from '@mui/icons-material';
        ...
        >
          ...
          <Box sx={{ maxWidth: 460, position: 'relative', zIndex: 2, textAlign: 'center' }}>
            ...
            <Typography sx={{ color: '#A0AEC0', fontSize: '1.05rem', lineHeight: 1.6, mb: 6 }}>
              Unlock full access to beautiful collage posts, real-time secure messaging, and a highly responsive minimal social space.
            </Typography>
            ...
            >
              <Box sx={{ display: 'flex', gap: 1.5, mb: 2, alignItems: 'center' }}>
                ...
                <Box>
                  <Typography sx={{ fontWeight: 700, fontSize: '0.85rem', color: '#fff' }}>Alex Smith</Typography>
                  <Typography sx={{ fontSize: '0.7rem', color: '#A0AEC0' }}>Community Lead</Typography>
                </Box>
                <AutoAwesome sx={{ color: '#FCD34D', fontSize: 16, ml: 'auto' }} />
              </Box>

              <Typography sx={{ fontSize: '0.88rem', color: '#E2E8F0', lineHeight: 1.5, mb: 2.5 }}>
                SocialVibe connects people globally through clean minimalism and interactive feeds. Create your account and say hello! 👋
              </Typography>

              <Box sx={{ display: 'flex', gap: 2.5, color: '#A0AEC0' }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.6 }}>
                  <Favorite sx={{ fontSize: 15, color: '#EF4444' }} />
                  <Typography sx={{ fontSize: '0.75rem', fontWeight: 600, color: '#E2E8F0' }}>128</Typography>
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.6 }}>
                  <Comment sx={{ fontSize: 14 }} />
                  <Typography sx={{ fontSize: '0.75rem', fontWeight: 600 }}>31</Typography>
                </Box>
              </Box>
            </Box>
          </Box>
            ...
            >
                    ...
                    InputProps={{
                      startAdornment: (
                        <InputAdornment position="start">
                          <Person sx={{ color: '#A0AEC0', fontSize: 18 }} />
                        </InputAdornment>
                      ),
                      sx: inputSx,
                    }}
              ...
              >
                <Typography sx={{ color: '#536471', fontSize: '0.85rem', fontWeight: 500 }}>
                  Already a member?{' '}
                  <Link to="/login" style={{ color: '#0F1419', fontWeight: 700, textDecoration: 'none' }}>
                    Sign in
                  </Link>
                </Typography>
              </Box>
